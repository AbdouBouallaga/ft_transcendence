...
const Profile = (props: any) => {
  ...
  useEffect(() => {
    ...
    if (router.query.param) {
      if (router.query.param[0]) user = router.query.param[0];
      setItsme(false);
    }
    let init = false;
      ...
      <>
        <div className="card m-2">
          <Avatar
            ...
            rounded={false}
            status={
              users[profile.username] !== undefined
                ? (statustab[users[profile.username].status] as any)
                : "offline"
            }
              ...
              <div className="flex">
                  ...
                  <>
                    ...
                    <React.Fragment>
                      {profile.tfaEnabled ? (
                        ...
                        <Button className="m-2" onClick={enable2fa}>
                          Enable 2fa
                        </Button>
                      )}
                      <Modal
                ...
                {profile.login42 !== props.profile.login42 &&
                  ...
                  <>
                    {!profile.blocking ? (
                      <>
                        {props["profile"]["friends"].findIndex(
                          (x: any) => x["login42"] === profile["login42"]
                        ) === -1 ? (
                          <Button
                            className="m-2"
                            onClick={() => {
                              ...
                              <Table.Cell className="">
                                <div className="flex flex-row justify-between">
                                  <div
                                    ...
                                    onClick={() => {
                                      router.replace(
                                        `/profile/` + e["winner"]["username"]
                                      );
                                    }}
                                  >
                                    <Avatar img={e["winner"]["avatar"]} />
                                    <h2 className="font-bold m-auto ml-1 text-sm">
                                      {e["winner"]["username"]}
                                    </h2>
                                  </div>
                                  <h2 className="font-bold m-auto text-lg">
                                    {e["winnerScore"] + "-" + e["loserScore"]}
                                  </h2>
                                  <div
                                    className="flex flex-row"
                                    onClick={() => {
                                      router.replace(
                                        `/profile/` + e["loser"]["username"]
                                      );
                                    }}
                                  >
                                    <h2 className="font-bold m-auto mr-1 text-sm">
                                      {e["loser"]["username"]}
                                    </h2>
                ...
                <div className="flex-2 card m-2 min-w-[240px]">
                  ...
                  <div className="flex overflow-auto flex-row  max-h-[300px] max-w-[609px]">
                    <div className="flex space-x-0 flex-wrap justify-center p-1">
                      {profile.games.length > 0 && <Heart />}
                      {profile.games.length > 2 && <Win_3 />}
                      {profile.games.length > 4 && <Win_5 />}
                    </div>
                  </div>
                </div>
                    ...
                    {profile.friends.map((e: any, i: number) => (
                      ...
                      >
                        <Avatar
                          ...
                          size="lg"
                          status={
                            users[e["username"]] !== undefined
                              ? (statustab[users[e["username"]].status] as any)
                              : "offline"
                          }
                        />
